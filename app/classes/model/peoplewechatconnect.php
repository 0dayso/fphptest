...
class Model_PeopleWechatConnect extends \Orm\Model
{

	/**
	 * @var  string  table name to overwrite assumption
	 */
	protected static $_table_name = 'peoples_wechat_connects';
	...
	public function _event_before_insert()
	{
		...
		$this->people_id = ($this->people_id = \Auth::get_user_id()) ? $this->user_id[1] : 0;
	}
