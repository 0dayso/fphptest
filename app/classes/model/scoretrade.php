...
class Model_ScoreTrade extends \Orm\Model
{

	/**
	 * @var  string  table name to overwrite assumption
	 */
	protected static $_table_name = 'score_trades';
	...
	*/
	public static function getItems($fields = '*',$params = array(), $tables = array(), $order_by = array(), $page = 0, $top = 0){
		$items = Model_ScoreTrade::query();
		//判断是否多表查询
		if($tables){
