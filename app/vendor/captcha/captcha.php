...
class SimpleCaptcha {
		 ...
		 */
		public $fonts = array(
				'Antykwa'  => array('spacing' => -3, 'minSize' => 18, 'maxSize' => 22, 'font' => 'AntykwaBold.ttf'),
				// 'Candice'  => array('spacing' =>-1.5,'minSize' => 28, 'maxSize' => 31, 'font' => 'Candice.ttf'),
				// 'DingDong' => array('spacing' => -2, 'minSize' => 21, 'maxSize' => 25, 'font' => 'Ding-DongDaddyO.ttf'),
		...
		public function __construct($config = array()) {
			$this->resourcesPath = realpath(__DIR__.DS.'resources');
		}
		...
		protected function WriteText($text, $fontcfg = array()) {
				...
				// $x      = 20*$this->scale;
				$x      = 10*$this->scale;
				$y      = round(($this->height*27/40)*$this->scale) + 2;
				$length = strlen($text);
				for ($i=0; $i<$length; $i++) {
