...
<form class="form" step="1" action="/web/home/login" name="loginfrm" id="loginfrm" method="post">
<input id="reg_from" type="hidden" name="reg_from" value="">
...
<div class="weui_cell weui_vcode we_width84">
	...
	<div class="weui_cell_bd">
		<input name="accpwd" maxlength="16" class="weui_input ft44" type="password" placeholder="请输入密码" errtips="请输入正确的密码">
	</div>
</div>
